...
| **수급(기관 순매수) 🆕** | 종목별 기관/외국인/개인 순매수 수량을 REST polling으로 조회 |
...
| 수급 조회 간격 🆕 | 종목별 기관/외국인/개인 순매수 REST 조회 간격 (20~600초, 기본 60초) |
...
> 웹소켓이 아니라 REST polling(기본 60초 간격)으로 갱신됩니다.
...
- 수급 polling은 최대 60초(기본값) 지연이 있음 → 잠시 기다려보기
